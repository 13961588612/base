...
### W1 · Python 基础（禁止跳过）
- [ ] 变量、list/dict、if/for/while — 心
- [ ] 函数 def、参数、返回值 — 心
- [ ] class + `__init__` + 方法 — 边
- [ ] import 与 `if __name__ == "__main__"` — 心
- [ ] try/except、读写文件、JSON — 边
- [ ] 能**读** `@decorator` 代码（不要求 W1 会写） — 心
- [ ] `p0-python-drills` ≥16/20 — 馈
- [ ] 命令行 Todo + JSON 持久化 — 边
- [ ] 费曼：list vs dict 何时用 — 费
